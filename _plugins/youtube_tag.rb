  ...
  class YouTubeTag < Liquid::Tag
    ...
    def render(context)
      ...
      if @videoid
        ...
        video += %Q{<div class="bt-video-container" style="position:relative;padding-bottom:#{padding_bottom};padding-top:30px;height:0;overflow:hidden"><iframe width="#{@width}" height="#{@height}" src="http://www.youtube.com/embed/#{@videoid}?rel=0&autoplay=1&loop=1&controls=1" frameborder="0" allowfullscreen></iframe></div>}
      else
